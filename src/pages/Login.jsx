        ...
        <div className="panel-inner">
          ...
          <div className="panel-headline">
            <h1 className="headline-text">
              Your workspace,<br />
              <span className="headline-accent">always on.</span>
            </h1>
            <p className="headline-sub">
              Real-time collaboration, smart workflows, and beautiful analytics — all in one place.
            </p>
          </div>
          ...
          <div className="panel-testimonial">
            <div className="testimonial-stars" aria-label="5 stars">
              {[...Array(5)].map((_, i) => (
                <svg key={i} width="14" height="14" viewBox="0 0 24 24" fill="#FAC775" aria-hidden="true">
                  <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>
                </svg>
              ))}
            </div>
            <p className="testimonial-quote">
              "Ember transformed how our team collaborates. The real-time features alone saved us 10+ hours a week."
            </p>
      ...
      <main className="login-form-section">
        <div className="form-card">
          ...
          <div className="form-header">
            ...
            <p className="form-subtitle">Sign in to continue to Ember</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="login-form" noValidate>
            ...
            <div className="field-group">
              ...
              <div className="field-wrap">
                <svg className="field-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
